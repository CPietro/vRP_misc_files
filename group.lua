...
function vRP.getGroupName(group)
  
  for k,v in pairs(groups) do
    if k == group then
      local kgroup = groups[k]
      if kgroup._config and kgroup._config.name then
        local r = kgroup._config.name
        return r
      end
    end
  end
...
function vRP.getGroupFiglio(group)

  for k,v in pairs(groups) do
    if k == group then
      local kgroup = groups[k]
      if kgroup._config and kgroup._config.figlio then
        local r = kgroup._config.figlio
        return r
      end
    end
  end
